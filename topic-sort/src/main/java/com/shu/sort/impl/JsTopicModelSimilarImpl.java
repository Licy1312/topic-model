...
public class JsTopicModelSimilarImpl implements ICommonTextSimilar {
    ...
    private String topicDistributefile = "D:/data/topic/model/model-final.theta";
     ...
     * @return
     */
    public double[] gainDocSimilarValue(int id){
        ...
        double target[] = docDistributeMap.get(id);
        ...
        log.info("文档主题分布之间的差异为:{}",similarValue.length);
