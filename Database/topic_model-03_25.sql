...
-- ----------------------------
-- Table structure for `documentDO`
-- ----------------------------
DROP TABLE IF EXISTS `documentDO`;
CREATE TABLE `documentDO` (
